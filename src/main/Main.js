...
function Main() {
  ...
  return (
    <div className={classes.root}>
      <MainPagePaper items={["Подготовьтесь к выполнению определенных типов заданий", "Потренируйтесь выполнять задания на определенную тему"]} to="/themes">Подготовка по тематическим блокам</MainPagePaper>
